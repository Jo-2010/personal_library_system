...
<body>
    ...
    <?php
        //Adding, in a non-necessary manner, the "table.php" and "formulary.php" files to display the books and make the form for saving a book available.
        include __DIR__ . "/table.php";
        include __DIR__ . "/formulary.php";
        //Destroying the following associative indices of the "$_SESSION" superglobal variable: "errors", "oldValues", "message", and "messageFormSave".
